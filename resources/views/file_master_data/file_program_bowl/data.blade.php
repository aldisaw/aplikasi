<table border="0" id='mytable' width="100%" style=border-collapse:collapse;>
     ...
     <tr bgcolor="#ADBA9A" dir-paginate="value in data | itemsPerPage:7" total-items="totalItems">  
          ...
          <td id='td' align="center">@{{value.satuan}}</td>
          ...
          <td id='td' width="5%" align="center"><img src="images/cross.png" width="25px" height="25px" style="cursor:pointer;" title="Hapus @{{value.nama_produk}}" ng-click="konfirmasi_hapus(value.nama_produk, 'data/program-bowl', value.id);"/> <img src="images/e.png" width="17px" height="17px" style="cursor:pointer;" title="Update @{{value.nama_produk}}" ng-click="toggle('edit', value.id, 'form-edit', 'data/program-bowl/', 'program-bowl')" /></td>
     
</table>
<dir-pagination-controls class="pull-right" on-page-change="pageChanged(newPageNumber, 'data/program-bowl/home/data.html')" template-url="templates/dirPagination.html" ></dir-pagination-controls>
