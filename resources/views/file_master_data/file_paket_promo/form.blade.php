            ...
            <div id="list">
                <div class="isi_divda">
                    <table width="100%" border="0" align=center bgcolor="" style="padding:10px 10px 10px;">
                        <tr class="tinggi">
                            <td width="20%">
                                <font size="3" color=green>File Paket Promo</font>
                            ...
                            <td align="right">
                                <div class="input-group">
                                    <input type="text" class="form-control input-sm ng-valid ng-dirty" placeholder="Search" ng-model="searchText" ng-enter="cari_data('data/paket-promo/home/data.html');" name="table_search" title="" tooltip="" data-original-title="Min character length is 3">
                                    <span class="input-group-addon" >Search</span>
                                </div>
                            <td width="10%" align="right">
                                <button class="btn btnb btn-success" data-toggle="modal" ng-click="toggle('form_input', halaman, 'form', 'data/paket-promo/','1')" >Buat Baru</button>
                        <tr>
                            <td><br>
                        <tr>
                            <td colspan="6">
                                @include('file_master_data.file_paket_promo.data')
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="container" style="width:100%;">
                        <table width="100%" border="0" align=center bgcolor="" style="padding:10px 10px 10px;">
                            <tr>
                                <td colspan="6">
                                    @include('file_master_data.file_paket_promo.data_treatment')
                            </tr>
                        </table>    
                    </div>
                </div>
    ...
    <div class="modal fade" id="form" tabindex="-1" style="font-family: arial;" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document" style="width:70%;">
            <div class="modal-content">
                <form method="POST" class="avatar-form" name="addItem" role="form" ng-submit="simpan('simpan/paket-promo/simpan/simpan', halaman, 'mlt', 'num', 'pg', 'data/paket-promo/home/data.html');">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <table border="0" width="100%">
                            <tr>
                                <td valign="top"><h4 class="modal-title" id="myModalLabel">Tambah Data Paket Promo</h4>
                    ...
                    <div class="modal-body">
                        <div class="container" style="width:100%;">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        <strong>Nama Promo : </strong>
                                        <div class="form-group">
                                            <input ng-model="form.nama_promo" type="text" placeholder="Nama Promo" name="nama_promo" class="form-control" required />
                                        </div>
                            ...
                            <div class="row col-xs-6">
                                <div class="">
                                    <div class="form-group">
                                        <strong>Harga : </strong>
                                        <div class="form-group">
                                            <input ng-model="form.harga" type="text" placeholder="Harga Paket" name="harga" id="harga" onblur=formatrupiah(this.value,'Rp.','harga','v'); onkeypress="return isNumberKey(event)" style="text-align:right" class="form-control" required />
                                        </div>
                            ...
                            <div class="row ">
                                <div class="col-xs-6">
                                   <strong>Jumlah Tratment : </strong>
                                    <div class="form-group">
                                        <input ng-model="form.jumlah_treatment" name="jumlah_treatment" type="text" placeholder="Jumlah Treatment"  onkeypress="return isNumberKey(event)" style="text-align:right" class="form-control" required />
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="form-edit" tabindex="-1" style="font-family: arial;" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document" style="width:70%">
            <div class="modal-content">
                <form method="POST" class="avatar-form" name="addItem" role="form" ng-submit="edit('simpan/paket-promo/form.id/update',halaman);">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <table border="0" width="100%">
                            <tr>
                                <td valign="top"><h4 class="modal-title" id="myModalLabel">Edit Data Paket Promo</h4>
                                <td><img src="images/2rcahwx.png" width="30" height="30" />
                            </tr>
                        </table>
                    </div>
                            ...
                            <div class="row col-xs-6">
                                <div class="">
                                    <div class="form-group">
                                        <strong>Harga : </strong>
                                        <div class="form-group">
                                            <input ng-model="form.harga" type="text" placeholder="Harga Paket" name="harga" id="harga"  onkeypress="return isNumberKey(event)" onblur=formatrupiah(this.value,'Rp.','harga','v'); style="text-align:right" class="form-control" required />
                                        </div>
