<table border="0" id='mytable' width="100%" style=border-collapse:collapse;>
     <tr bgcolor="#ADBA9A">  
          ...
          <th class='th' width="8%">Expired</th>
     ...
     <tr  bgcolor="#ADBA9A" dir-paginate="value in data | itemsPerPage:13" total-items="totalItems" style="cursor:pointer;" title="Produk @{{value.nama_produk}} ">  
          ...
          <td id='td' align="center"><img src="images/cross.png" width="25px" height="25px" style="cursor:pointer;" title="Hapus @{{value.nama_produk}}" ng-click="konfirmasi_hapus(value.nama_produk, 'data/barang-masuk-apotek', value.kode_transaksi);"/>  <img src="images/e.png" width="17px" height="17px" style="cursor:pointer;" title="Update @{{value.nama_produk}}" ng-click="transfer_edit(value.kode_produk,value.nama_produk,value.kode_transaksi,value.jumlah,value.exd,value.tgl,value.keterangan,'','','','','','','','','','','','','','','','','','','', '', 'produk-masuk', 'form-edit')" /></td>
     
</table>
<dir-pagination-controls class="pull-right" on-page-change="pageChanged(newPageNumber, 'data/barang-masuk-apotek/home/data.html')" template-url="templates/dirPagination.html" ></dir-pagination-controls>
