            ...
            <div id="list">
                <div class="isi_divda">
                    <table width="100%" border="0" align=center bgcolor="" style="padding:10px 10px 10px;">
                        <tr class="tinggi">
                            <td width="20%">
                                <font size="3" color=green>File Barang Masuk Apotek</font>
                            <td width="5%"><img src="images/barang_masuk_apotek.png" width="30" height="30" />
                            <td width="23%">
                            ...
                            <td align="right">
                                <div class="input-group">
                                    <input type="text" class="form-control input-sm ng-valid ng-dirty" placeholder="Search" ng-model="searchText" ng-enter="cari_data('data/barang-masuk-apotek/home/data.html');" name="table_search" title="" tooltip="" data-original-title="Min character length is 3">
                                    <span class="input-group-addon" >Search</span>
                                </div>
                            <td width="10%" align="right">
                                <button class="btn btnb btn-success" data-toggle="modal" ng-click="toggle('form_input', halaman, 'form', 'data/barang-masuk-apotek/','1')" >Buat Baru</button>
                        <tr>
                            <td><br>
                        <tr>
                            <td colspan="6">
                                @include('file_master_data.file_barang_masuk_apotek.data')
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="container" style="width:100%;">
                        <table width="100%" border="0" align=center bgcolor="" style="padding:10px 10px 10px;">
                            <tr>
                                <td colspan="6">
                                    @include('file_master_data.file_barang_masuk_apotek.data_produk')
                            </tr>
                        </table>    
                    </div>
                </div>
    ...
    <div class="modal fade" id="form" tabindex="-1" style="font-family: arial;" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document" style="width:70%">
            <div class="modal-content">
                <form method="POST" class="avatar-form" name="addItem" role="form" ng-submit="simpan('simpan/barang-masuk-apotek/simpan/simpan', halaman, 'mlt', 'num', 'pg', 'data/barang-masuk-apotek/home/data.html');">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <table border="0" width="100%">
                            <tr>
                                <td valign="top"><h4 class="modal-title" id="myModalLabel"><font color="green">Tambah Data Produk Masuk </font> | <font color="#e2750a"> @{{tgl | date:"dd/MM/yyyy"}} </font> | <font color="#9c1516">{{ Auth::user()->name }}</font></h4>
                                <td><img src="images/barang_masuk_apotek.png" width="30" height="30" />
                            </tr>
                        </table>
                    </div>
                    <div class="modal-body">
                        <div class="container" style="width:100%;">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        <strong>Nama Produk : </strong>
                                        <input ng-model="form.nama_produk" readonly="true" type="text" placeholder="Name Produk, clik untuk mencari produk" style="cursor:pointer;" name="nama_produk" class="form-control" ng-click="toggle('form_input', halaman2, 'form-produk', 'data/produk/home/data.html','2', '', '', '', '1500', '7')" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row col-xs-6">
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        <input ng-model="form.tanggal_masuk"  type="text" datetime-picker date-format="yyyy-MM-dd" name="tanggal_masuk" class="form-control" required />
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="form-edit" tabindex="-1" style="font-family: arial;" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document" style="width:70%">
            <div class="modal-content">
                <form method="POST" class="avatar-form" name="addItem" role="form" ng-submit="edit('simpan/barang-masuk-apotek/edit/update',halaman);">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <table border="0" width="100%">
                            <tr>
