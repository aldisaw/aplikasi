            ...
            <div id="list" >
                <div class="isi_divda" on-page-change="">
                    <table width="100%" border="0" align=center bgcolor="" style="padding:10px 10px 10px;">
                        <tr class="tinggi">
                            <td width="15%">
                                <font size="3" color=green>File Paket Produk</font>
                            <td width="5%"><img src="images/dwedeew.ico" width="30" height="30" />
                            <td width="23%">
                                <div class="input-group">
                                    <select class="form-control input-sm ng-valid ng-dirty" ng-model="par">
                                        <option value="nama_paket">Nama Paket</option>
                                        <option value="harga_paket">Harga Paket</option>
                                    </select>
                            ...
                            <td align="right" width="20%">
                                <div class="input-group">
                                    <input type="text" class="form-control input-sm ng-valid ng-dirty" placeholder="Cari Paket" ng-model="searchText" ng-enter="cari_data('data/sub-paket-produk/home/data.html');" name="table_search" title="" tooltip="" data-original-title="Min character length is 3">
                                    <span class="input-group-addon" >Cari</span>
                                </div>
                            <td width="13%" align="right">
                                <button class="btn btnb btn-success" data-toggle="modal" ng-click="toggle('form_input', halaman, 'form-paket-produk', 'data/paket-produk/','1')" >Buat Paket Produk Baru</button>
                        <tr>
                            <td colspan="6">
                              <div id="detil">
                    ...
                    <div class="isi_divda" on-page-change="">
                        <table width="100%" border="0" align=center bgcolor="" style="padding:10px 10px 10px;">
                            <tr class="tinggi">
                                ...
                                <td width="5%"><img src="images/dwedeew.ico" width="30" height="30" />
                                <td width="10%">
                                <td width="5%" align="center"><img src="images/database_256.png" width="30" height="30" />
                                <td align="center" width="15%"> <font size="3" color=green>Total Produk : @{{isi.detail.total}}</font>
                                <td width="10%" align="right">
                                    <button class="btn btnb btn-success" data-toggle="modal" ng-click="toggle('form_input', $index, 'form', 'data/sub-paket-produk/','3', isi.nama_paket, isi.kode_paket)" >Buat Baru</button>
                            <tr>
                                <td colspan="6">
                                  <BR>
                                  <div id="@{{$index}}">
                                    @include('file_master_data.file_sub_paket_produk.data')
                                  </div>
                                  ...
                                  <paging
                                      ...
                                      ng-click="pageChanged_multi(currentPage, 'data/sub-paket-produk/', 'multi', $index, detail[$index].kode_paket)">
                                  </paging>  
                ...
                <div class="modal-body">
                    <div class="container" style="width:100%;">
                        <table width="100%" border="0" align=center bgcolor="" style="padding:10px 10px 10px;">
                            <tr>
                                <td colspan="6">
                                    @include('file_master_data.file_sub_paket_produk.data_produk')
                            </tr>
                        </table>    
                    </div>
                </div>
    ...
    <div class="modal fade" id="form-paket-produk" tabindex="-1" style="font-family: arial;" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document" style="width:70%">
            <div class="modal-content">
                <form method="POST" class="avatar-form" name="addItem" role="form" ng-submit="simpan('simpan/paket-produk/simpan/simpan', halaman, '1', '', '', 'data/sub-paket-produk/home/data.html');">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <table border="0" width="100%">
                            <tr>
                                <td valign="top"><h4 class="modal-title" id="myModalLabel">Tambah Data Paket</h4>
                                <td><img src="images/dwedeew.ico" width="30" height="30" />
                            </tr>
                        </table>
                    </div>
                    <div class="modal-body">
                        <div class="container" style="width:100%;">
                            ...
                            <div class="row col-xs-6">
                                <div class="">
                                    <strong>Harga : </strong>
                                    <div class="form-group">
                                        <input ng-model="form.harga" type="text" placeholder="Harga Paket " name="harga" id="harga" onkeypress="return isNumberKey(event)" style="text-align:right" onblur=formatrupiah(this.value,'Rp.','harga','v'); class="form-control" required />
                                    </div>
                                </div>
                            </div>
    ...
    <!--form input sub Produk paket-->
    <div class="modal fade" id="form" tabindex="-1" style="font-family: arial;" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document" style="width:70%">
            <div class="modal-content">
                <form method="POST" class="avatar-form" name="addItem" role="form" ng-submit="simpan('simpan/sub-paket-produk/simpan/simpan', index, '1', '', '', 'data/sub-paket-produk/home/data.html');">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <table border="0" width="100%">
                            <tr>
                                <td valign="top"><h4 class="modal-title" id="myModalLabel">Tambah Data Produk Paket - <font color="green">@{{nama_dt}} </font> </h4>
                                <td><img src="images/database_256.png" width="50" height="50" />
                            </tr>
                        </table>
                    </div>
                    <div class="modal-body">
                        <div class="container" style="width:100%;">
                            ...
                            <div class="row col-xs-6">
                                <div class="">
                                    <strong>Kode Produk Paket : </strong>
                                    <div class="form-group">
                                        <input ng-model="form.kode_detail_paket" readonly="true" type="text" placeholder="Kode Produk Paket" name="kode_detail_paket" class="form-control" required />
