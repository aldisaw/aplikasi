<table border="0" id='mytable' width="100%" style=border-collapse:collapse;>
     <tr bgcolor="#ADBA9A">  
          ...
          <th class='th' width="20%">Nama Paket Produk</th>
     ...
     <tr bgcolor="#ADBA9A" dir-paginate="value in data | itemsPerPage:7" total-items="totalItems">  
          ...
          <td id='td' width="5%" align="center"><img src="images/cross.png" width="25px" height="25px" style="cursor:pointer;" title="Hapus @{{value.nama_paket}}" ng-click="konfirmasi_hapus(value.nama_paket, 'data/paket-produk', value.kode_paket);"/> <img src="images/e.png" width="17px" height="17px" style="cursor:pointer;" title="Update @{{value.nama_paket}}" ng-click="toggle('edit', value.kode_paket, 'form-edit', 'data/paket-produk/')" /></td>
     
</table>
<dir-pagination-controls class="pull-right" on-page-change="pageChanged(newPageNumber, 'data/paket-produk/home/data.html')" template-url="templates/dirPagination.html" ></dir-pagination-controls>
