<table border="0" id='mytable' width="100%" style=border-collapse:collapse;>
     ...
     <tr bgcolor="#ADBA9A" dir-paginate="value in dtl | itemsPerPage:7" total-items="totalItems" style="cursor:pointer;" title="Pilih @{{value.nama_produk}}" ng-click="transfer(value.kode_produk, value.nama_produk, form.kode_produk_treatment, form.kode_treatment, 'form-produk', 'produk-transfer');">  
